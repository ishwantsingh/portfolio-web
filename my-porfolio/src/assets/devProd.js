...
function SvgDevProd2(props) {
  // const laptop = React.useRef(null);
  // const laptopStand = React.useRef(null);
  // const leafLeft = React.useRef(null);
  // const leafRight = React.useRef(null);
  // const clockCircle = React.useRef(null);
  // const clockOutline = React.useRef(null);

  const svgTween = new TimelineMax();

  React.useEffect(() => {
    svgTween
      .from("#laptopStand", 0.5, {
        scaleX: 0,
      ...
      // // .from("#person", 0.3, {scaleY: 0, transformOrigin: "top", ease: "slow.easeIn" })
      // //  .from("#clockHand", 0.5, {scaleY: 0, rotation: 360, transformOrigin: "bottom", ease: "power2.easeOut"})
      .from("#clock", 0.3, {
        scale: 0,
  ...
  return (
    <svg data-name="Layer 1" viewBox="0 0 798.627 689.223" {...props}>
