...
function SvgDevProd2(props) {
  ...
  return (
    <svg data-name="Layer 1" viewBox="0 0 798.627 689.223" {...props}>
      <circle id="person" cx={435.922} cy={118.405} r={73.536} fill="#a0616a" />
      <path
        id="person"
      ...
      <circle
        ...
        strokeWidth={2}
      />
      <circle id="laptop" cx={415.5} cy={493.326} r={25} fill="#d0cde1" />
      <path id="laptopStand" fill="#d0cde1" d="M80.446 661.223h28v28h-28z" />
      <path
        id="laptopStand"
        d="M91.45 639.223v34h34v-34zm32.52 32.52H92.92v-31.04h31.05z"
        fill="#3f3d56"
      />
      <path id="laptopStand" fill="#d0cde1" d="M728.446 661.223h28v28h-28z" />
      <path
        id="laptopStand"
        d="M739.45 639.223v34h34v-34zm32.52 32.52h-31.05v-31.04h31.05z"
        fill="#3f3d56"
      />
      <circle id="clock" cx={94.58} cy={150.773} r={79.34} fill="#cef6ff" />
      <path
        id="clock"
